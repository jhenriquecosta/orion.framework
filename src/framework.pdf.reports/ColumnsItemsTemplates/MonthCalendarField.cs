...
using Orion.Framework.Pdf.Reports.Calendar;
using Orion.Framework.Pdf.Reports.Core.Contracts;

namespace Orion.Framework.Pdf.Reports.ColumnsItemsTemplates
{
    /// <summary>
    /// Displaying current cell's data as a calendar.
    /// Calendar's cell data type should be Orion.Framework.Pdf.Reports.Calendar.CalendarData. Use DaysInfoToCalendarData.MapToCalendarDataList to map list of the DayInfo's to the list of CalendarData's.
    /// </summary>
    public class MonthCalendarField : IColumnItemsTemplate
    {
        ...
        public PdfPCell RenderingCell(CellAttributes attributes)
        {
            ...
            if (data == null)
                throw new InvalidOperationException("Calendar's cell data type is not Orion.Framework.Pdf.Reports.Calendar.CalendarData. Use DaysInfoToCalendarData.MapToCalendarDataList to map list of the DayInfo's to the list of CalendarData's.");
