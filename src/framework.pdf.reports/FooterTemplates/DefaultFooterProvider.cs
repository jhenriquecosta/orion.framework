...
namespace Orion.Framework.Pdf.Reports.FooterTemplates
{
    /// <summary>
    /// A helper class/sample which demonstrates how to implement the IOrion.Framework.Pdf.ReportsCustomFooter to produce the pdfDoc's footer
    /// </summary>
