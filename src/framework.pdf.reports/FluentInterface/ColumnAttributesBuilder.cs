...
using Orion.Framework.Pdf.Reports.ColumnsItemsTemplates;
...
namespace Orion.Framework.Pdf.Reports.FluentInterface
{
    ...
    public class ColumnAttributesBuilder
    {
        ...
        /// If GroupsPreferences.GroupType is set to Orion.Framework.Pdf.ReportsGroupType.IncludeGroupingColumns, this property will be ignored.
        /// </summary>
        ...
        /// <param name="horizontalAlignment">Content's Horizontal alignment. If null, IOrion.Framework.Pdf.ReportsTemplate.HeaderHorizontalAlignment will be used.</param>
