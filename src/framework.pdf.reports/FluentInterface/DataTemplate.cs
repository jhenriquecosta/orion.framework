...
using Orion.Framework.Pdf.Reports.Core.Core.Helper;
...
namespace Orion.Framework.Pdf.Reports.FluentInterface
{
    ...
    public abstract class DataTemplate : IPdfReportData
    {
        ...
        Orion.Framework.Pdf.Reports.Core.Contracts.Events _mainTableEvents = new Orion.Framework.Pdf.Reports.Core.Contracts.Events();
        ...
        /// </summary>
        public Orion.Framework.Pdf.Reports.Core.Contracts.Events MainTableEvents
        {
        ...
        public void SetMainTableEvents(Orion.Framework.Pdf.Reports.Core.Contracts.Events mainTableEvents)
        {
