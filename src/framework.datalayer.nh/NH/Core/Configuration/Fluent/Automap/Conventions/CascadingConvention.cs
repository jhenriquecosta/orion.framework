...
namespace Orion.Framework.DataLayer.NH.Fluent.Conventions
{
    ...
    public class CascadingConvention : IHasManyConvention, IReferenceConvention, IHasOneConvention
    {
        ...
        {
            var rootSubclass = typeof(IAggregateRoot).IsAssignableFrom (instance.Relationship.Class.GetUnderlyingSystemType () );
        ...
        {
            var rootSubClass = typeof(IAggregateRoot ).IsAssignableFrom ( instance.Property.PropertyType );
            ...
            {
                var noneCascadingAttributeAttributes = instance.Property.MemberInfo.GetCustomAttributes (typeof( NoneCascadingAttribute ), false );
