...
namespace Orion.Framework.Domains.Primitives
{
    /// <summary>
    /// Strategy for postal code type naming.
    /// </summary>
    public class PostalCodeTypeNamingStrategy : IComponentNamingStrategy
    {
            ...
            bool shortNameIndicator = false )
        {
            ...
            if ( valueObjectPropertyName != PropertyHelper.ExtractPropertyName<PostalCode, string> ( p => p.Code ) )
            {
