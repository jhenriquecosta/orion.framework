...
using Orion.Framework.Ui.FWorks.Blazor.Sf.Modals;

namespace Orion.Framework.Ui.FWorks.Blazor.Sf.Forms
{


    public abstract class PageFormModel<TModel> : PageForm where TModel : class, IEntity<TModel, int>, new()
    {
        ...
        protected void OnHideModal(FwModal oxModal)
        {
    ...
    public abstract class PageFormModel<TModel, TDataService> : PageFormModel<TModel> where TDataService : DaoDomainService<TModel>  where TModel : class, IEntity<TModel, int>,new()
    {
        #region Properties
