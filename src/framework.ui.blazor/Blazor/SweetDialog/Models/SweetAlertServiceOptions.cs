...
namespace Orion.Framework.Ui.Blazor.Components
{
    ...
    public class SweetAlertServiceOptions
    {
        ...
        internal Dictionary<ColorScheme, SweetAlertTheme> ColorSchemeThemes { get; private set; } = 
        ...
        /// Browsers that do not support the feature will fall back to the theme set in <code>SweetAlertServiceOptions.Theme</code>.
        /// </summary>
